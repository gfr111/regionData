...
__vue_options__.__file = "F:\\weex项目\\教练派门店数据\\regionData\\src\\components\\main.vue"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.startDate.substring(0, 4) + '-' + _vm.startDate.substring(5, 7) + '-' + _vm.startDate.substring(8, 10)))]), (_vm.timeIndex != 0 && _vm.timeIndex != 1) ? _c('text', {
    staticClass: ["planDate"],
    on: {
      "click": function($event) {
        _vm.getTime(2)
  ...
  }, [_vm._v("至" + _vm._s(_vm.endDate.substring(0, 4) + '-' + _vm.endDate.substring(5, 7) + '-' + _vm.endDate.substring(8, 10)))]) : _vm._e()]), _c('image', {
  ...
  }, [_vm._v(_vm._s(_vm.bodyCheckCount))])]), _c('div', {
    staticClass: ["regionDataItem"]
  }, [_vm._m(1), _c('text', {
    staticClass: ["itemData"]
  }, [_vm._v(_vm._s(_vm.trainProgramCount))])]), _c('div', {
    staticClass: ["regionDataItem"]
  }, [_vm._m(2), _c('text', {
    staticClass: ["itemData"]
  }, [_vm._v(_vm._s(_vm.trialCourseCount))])]), _c('div', {
    staticClass: ["regionDataItem"]
  }, [_vm._m(3), _c('text', {
    staticClass: ["itemData"]
  }, [_vm._v(_vm._s(_vm.courseCount))])]), _c('div', {
    staticClass: ["regionDataItem"]
  }, [_vm._m(4), _c('text', {
    staticClass: ["itemData"]
  }, [_vm._v(_vm._s(_vm.patrolCount))])])])]), (_vm.isRegion) ? _c('div', {
    ...
    }, [_vm._v(_vm._s(item.regionName))]), _c('text', {
      staticClass: ["lines"]
    })]), _c('div', {
    ...
    }, [_vm._v(_vm._s(item.bodyCheckCount))])]), _c('div', {
      staticClass: ["bottomItem"]
    }, [_c('text', {
      staticStyle: {
        color: "#999999",
    ...
    }, [_vm._v(_vm._s(item.trainProgramCount))])]), _c('div', {
      staticClass: ["bottomItem"]
    }, [_c('text', {
      staticStyle: {
        color: "#999999",
    ...
    }, [_vm._v(_vm._s(item.trialCourseCount))])]), _c('div', {
      staticClass: ["bottomItem"]
    }, [_c('text', {
      staticStyle: {
        color: "#999999",
    ...
    }, [_vm._v(_vm._s(item.courseCount))])]), _c('div', {
      staticClass: ["bottomItem"]
    }, [_c('text', {
      staticStyle: {
        color: "#999999",
    ...
    return (_vm.centerList.length != 0) ? _c('div', {
      ...
      staticClass: ["dataName"]
    }, [_vm._v(_vm._s(item.clubName))]), _c('text', {
      staticClass: ["lines"]
    })]), _c('div', {
      staticClass: ["listItemBottom"]
    }, [_c('div', {
  ...
  }), (_vm.regionList.length == 0 && _vm.centerList.length == 0) ? _c('div', {
    ...
    }, [_vm._v(_vm._s(index + 1))]) : _vm._e(), (index == 1) ? _c('text', {
      staticClass: ["rankNum", "numTwo"]
    }, [_vm._v(_vm._s(index + 1))]) : _vm._e(), (index == 2) ? _c('text', {
      staticClass: ["rankNum", "numThree"]
    }, [_vm._v(_vm._s(index + 1))]) : _vm._e(), (index >= 3) ? _c('text', {
      staticClass: ["rankNum", "numElse"]
    }, [_vm._v(_vm._s(index + 1))]) : _vm._e(), _c('image', {
    ...
    }, [_vm._v(_vm._s(item.bodyCheckCount))]), _c('text', {
      staticClass: ["dataName", "contentItem"]
    }, [_vm._v(_vm._s(item.programCount))]), _c('text', {
      staticClass: ["dataName", "contentItem"]
    }, [_vm._v(_vm._s(item.trialCourseCount))]), _c('text', {
      staticClass: ["dataName", "contentItem"]
    }, [_vm._v(_vm._s(item.completedCourseCount))]), _c('text', {
      staticClass: ["dataName", "contentItem"]
    }, [_vm._v(_vm._s(item.patrolCount))])])]) : _vm._e()
  }), (_vm.trainerList.length == 0) ? _c('div', {
    staticClass: ["emptyBox"],
    style: {
...
__vue_options__.__file = "F:\\weex项目\\教练派门店数据\\regionData\\src\\index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
